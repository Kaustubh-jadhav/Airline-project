		...
		<?php
			if(isset($_POST['Submit']))
			{
				...
				if(empty($data_missing))
				{
					...
					//$quary="INSERT INTO `customer` (`customer_id`, `pwd`, `name`, `email`, `phone_no`, `address`) VALUES ('$user_name', '$password', '$name', '$email_id', '$phone_no', '$address');";
					...
					//$query="INSERT INTO customer (customer_id,pwd,name,email,phone_no,address) VALUES (?,?,?,?,?)";
					//$quary = "INSERT INTO `customer`(customer_id, pwd,name,email,phone_no,address) VALUES ('?','?','?','?','?','?');";
					//echo "$query";
					//$stmt=mysqli_prepare($dbc,$query);
					//mysqli_stmt_bind_param($stmt,"ssssss",$user_name,$password,$name,$email_id,$phone_no,$address);
					//$stmt="insert into customer values('aaa','1234','xyz','abc@gmail.com','76676','Nasik')";
					//echo "hello";
