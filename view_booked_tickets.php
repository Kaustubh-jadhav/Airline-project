...
<html>
	...
	<body>
		...
		<?php
			...
			$query="SELECT pnr,date_of_reservation,flight_no,journey_date,class,booking_status,no_of_passengers,payment_id FROM ticket_details where customer_id='$customer_id' AND journey_date>='$todays_date' AND booking_status='CONFIRMED' ORDER BY  journey_date";
			...
			$query="SELECT pnr,date_of_reservation,flight_no,journey_date,class,booking_status,no_of_passengers,payment_id FROM ticket_details where customer_id='$customer_id' and journey_date<'$todays_date' and journey_date>='$thirty_days_before_date' ORDER BY  journey_date";
			$stmt=mysqli_prepare($dbc,$query);
