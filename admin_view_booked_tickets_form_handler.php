		...
		<div class="container">
			...
			if(isset($_POST['Submit']))
			{
				...
				if(empty($data_missing))
				{
					...
					$query="SELECT pnr,date_of_reservation,class,no_of_passengers,payment_id,customer_id FROM ticket_details where flight_no='$flight_no' and journey_date='$departure_date' and booking_status='CONFIRMED' ORDER BY class";
